              ...
              <div className="klaviyo-grid">
                <BlockStack gap="400">
                  ...
                  <Text as="p" variant="bodyMd">
                    Retrieve the Private API Keys from your Klaviyo account and
                    ensure the selected access level is Grant applications full
                    access for every API scope. This step is essential for
                    successful integration with Klaviyo. For instructions on
                    obtaining a Private API key with the specified scope, please
                    consult the provided documentation.
                  </Text>
                  <Link
                    url="https://help.klaviyo.com/hc/en-us/articles/7423954176283"
                    external
                    removeUnderline
                  >
