...
"
  ...
  const renderRightGridContent = () => {
    if (selectedTab === 0) {
            ...
            <div className="referrer-3rdcard">
              <Card>
                <div className="referrer-2ndcard-inside">
                  ...
                  >
                    <path
                      d="M50 29.707V48.5352C50 49.3458 49.3458 50 48.5352 50H9.30672C6.7482 50 4.70695 47.9198 4.70695 45.4002V24.8924H4.59976C2.08969 24.8924 0 22.8615 0 20.293V18.7206C0 16.1522 2.08969 14.1212 4.59976 14.1212H11.5135C10.2051 12.627 9.41391 10.664 9.41391 8.52547C9.41391 3.82805 13.2423 0 17.9394 0C20.8691 0 23.4669 1.49422 25 3.74985C26.5331 1.49422 29.1309 0 32.0606 0C36.7577 0 40.5861 3.82805 40.5861 8.52547C40.5861 10.6056 39.8438 12.5683 38.4865 14.1212H45.3907C47.9591 14.1212 49.9901 16.201 49.9901 18.7206V20.293C49.9901 22.8615 47.9103 24.8924 45.3907 24.8924H45.2831V28.2421H48.5352C49.3458 28.2421 50 28.8963 50 29.707ZM47.0703 47.0703V31.1718H18.623V47.0703H47.0703ZM47.0703 20.293V18.7206C47.0703 17.7929 46.3184 17.0509 45.4002 17.0509H26.4648V21.9627H45.4002C46.3184 21.9627 47.0703 21.2208 47.0703 20.293ZM42.3634 28.2421V24.8924H26.4648V28.2421H42.3634ZM36.0157 12.4805C37.0705 11.4258 37.6564 10.0197 37.6564 8.52547C37.6564 5.43938 35.1463 2.92969 32.0606 2.92969C28.9745 2.92969 26.4648 5.43938 26.4648 8.52547V14.1212H32.0606C33.5548 14.1212 34.9609 13.5353 36.0157 12.4805ZM23.5352 28.2421V24.8924H7.63664V45.3907C7.63664 45.8397 7.8125 46.2597 8.12492 46.5721C8.44727 46.8849 8.86726 47.0604 9.30672 47.0604H15.6837V29.707C15.6837 28.8963 16.338 28.2421 17.1486 28.2421H23.5352ZM23.5352 21.9627V17.0509H4.59976C3.67203 17.0509 2.92969 17.8028 2.92969 18.7206V20.293C2.92969 21.2208 3.68156 21.9627 4.59976 21.9627H23.5352ZM23.5352 14.1212V8.52547C23.5352 5.43938 21.0255 2.92969 17.9394 2.92969C14.8537 2.92969 12.3436 5.43938 12.3436 8.52547C12.3436 11.6112 14.8537 14.1212 17.9394 14.1212H23.5352Z"
                      fill="currentColor"
                    ></path>
                    <path
                      d="M43.7207 35.9863V42.2657C43.7207 43.0763 43.0665 43.7305 42.2559 43.7305C41.4452 43.7305 40.791 43.0763 40.791 42.2657V35.9863C40.791 35.1757 41.4452 34.5215 42.2559 34.5215C43.0665 34.5215 43.7207 35.1757 43.7207 35.9863Z"
                      fill="#4D77FF"
                    ></path>
                    <path
                      d="M32.8419 34.5215C35.381 34.5215 37.4413 36.5822 37.4413 39.1212C37.4413 41.6603 35.381 43.7206 32.8419 43.7206C30.3029 43.7206 28.2422 41.6603 28.2422 39.1212C28.2422 36.5822 30.3029 34.5215 32.8419 34.5215ZM34.5216 39.1212C34.5216 38.1935 33.7697 37.4512 32.8515 37.4512C31.9337 37.4512 31.1818 38.203 31.1818 39.1212C31.1818 40.0391 31.9337 40.7909 32.8515 40.7909C33.7697 40.7909 34.5216 40.0391 34.5216 39.1212Z"
                      fill="#4D77FF"
                    ></path>
                    <path
                      d="M24.8926 35.9863V42.2657C24.8926 43.0763 24.2384 43.7305 23.4277 43.7305C22.6175 43.7305 21.9629 43.0763 21.9629 42.2657V35.9863C21.9629 35.1757 22.6175 34.5215 23.4277 34.5215C24.2384 34.5215 24.8926 35.1757 24.8926 35.9863Z"
                      fill="#4D77FF"
                    ></path>
                  </svg>
      ...
      return (
        <Box padding="400">
          <div className="affliate-card-total">
            <div className="referral-card1">
              <Card>
                <div className="referral-card1-text1">
                  <Text as="p" variant="bodySm">
                ...
                <Grid.Cell columnSpan={{ xs: 6, sm: 3, md: 3, lg: 3, xl: 3 }}>
                  <div className="grid5">
                    <Card>
                      ...
                      <div className="grid-5-text">
                        <Text as="p" variant="bodyMd">
                          Total Paid
                        </Text>
                      </div>
                      <div className="grid-5-text2">
                        <Text as="h1" variant="headingLg">
                          $$$
                        </Text>
                      </div>
                      <div className="grid-5-btn">
                        <Button variant="primary">Convert as coupon</Button>
                      </div>
                    </Card>
                  </div>
                </Grid.Cell>
            ...
            <div className="affliate-text-table">
              <Text as="p" variant="bodyMd">
                Transactions
              </Text>
            </div>
            <div className="affliate-table1">
              <Card>
                <DataTable
                  columnContentTypes={["text", "numeric", "numeric"]}
                  headings={["Date", "Amount Debited", "Type"]}
                  rows={rows2}
                />
              </Card>
            </div>
            <div className="affliate-text-table2">
              <Text as="p" variant="bodyMd">
                Reward / Commission History
              </Text>
            </div>
            <div className="affliate-table2">
              <Card>
                <DataTable
                  columnContentTypes={[
                    "text",
