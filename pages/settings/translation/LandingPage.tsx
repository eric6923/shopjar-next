  ...
  return (
    <Grid>
      ...
      <Grid.Cell columnSpan={{ xs: 6, sm: 3, md: 3, lg: 6, xl: 6 }}>
        <div className="referral-grid-text">
          <Text as="p" variant="bodyLg">
            Referral reward is not available for existing customer or Invitation
            already sent!
          </Text>
        </div>
      </Grid.Cell>
      ...
      <Grid.Cell columnSpan={{ xs: 6, sm: 3, md: 3, lg: 6, xl: 6 }}>
        <div className="referral-grid-text">
          <Text as="p" variant="bodyLg">
            You should be an existing customer with at least one order to become
            a member and participate in the referral program
          </Text>
        </div>
      </Grid.Cell>
      <Grid.Cell columnSpan={{ xs: 6, sm: 3, md: 3, lg: 6, xl: 6 }}>
