        ...
        <InlineStack gap="200" align="start">
          ...
          <div className="text2-integrations">
            ...
            <Text as="p" variant="bodyLg">
              Klaviyo is a leading e-commerce marketing platform, empowering
              businesses to create personalized email campaigns, automate
              customer engagement, and drive sales growth with ease.
            </Text>
            <div className="button-integrations">
              <Button
                size="large"
                variant="primary"
                onClick={() => router.push("/settings/integration/klaviyo")}
              >
                <span
